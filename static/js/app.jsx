        ...
        return (
            <div className="container">
                <div className="col-xs-12 jumbotron text-center">
                    ...
                    <a onClick={this.authenticate} className="btn btn-primary btn-lg btn-login brtn-block">Sign In</a>
                </div>
            </div>);
    }
});
...
var LoggedIn = React.createClass({
    ...
    // Once this component mounts, we will make a call to the API to get the product data
